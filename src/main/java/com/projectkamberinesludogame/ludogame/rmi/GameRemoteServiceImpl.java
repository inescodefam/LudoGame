...
//    @Override
//    public boolean isOpponentReady(int playerColor) throws RemoteException {
//        int opponentColor = 1 - playerColor;
//        return players.containsKey(opponentColor);
//    }

//    @Override
//    public void sendGameState(String serializedGameState) throws RemoteException {
//        System.out.println("Broadcasting game state to all players");
//
//        for (GameCallback callback : players.values()) {
//            if (callback != null) {
//                try {
//                    callback.onGameStateReceived(serializedGameState);
//                } catch (RemoteException e) {
//                    System.err.println("Failed to send game state to a player: " + e.getMessage());
//                }
//            }
//        }
//    }
